...
if numTemperatureSensors
  ...
  text(model.HS.tempSensorPositions(:,1)-1.5*G.dx,model.HS.tempSensorPositions(:,2),model.HS.tempSensorPositions(:,3),sensorNumbers,'HorizontalAlignment','right','VerticalAlignment','middle','FontSize',18,'FontWeight', 'bold');
  hold on;
